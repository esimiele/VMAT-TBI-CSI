...
namespace VMATTBIAutoPlanMT
{
    public struct autoRunData
    {
        ...
        public List<Tuple<string, string>> scleroStructures;
        public StructureSet selectedSS;
        public double targetMargin;
        public bool isScleroRegimen;
        public bool useFlash;
        public Structure flashStructure;
        public double flashMargin;
        public List<Tuple<string, string, double>> structureSpareList;

        public void construct(List<Tuple<string, string>> tsStruct, List<Tuple<string, string>> scleroStruct, List<Tuple<string, string, double>> structSpareLst, StructureSet ss, double TgtMargin, bool scleroChecked,
            bool flash, Structure flshstruct, double flshmarg, VMS.TPS.Common.Model.API.Application a)
        {
            TS_structures = new List<Tuple<string, string>>(tsStruct);
            scleroStructures = new List<Tuple<string, string>>(scleroStruct);
            structureSpareList = new List<Tuple<string, string, double>>(structSpareLst);
            selectedSS = ss;
            targetMargin = TgtMargin;
            isScleroRegimen = scleroChecked;
            useFlash = flash;
            flashStructure = flshstruct;
            flashMargin = flshmarg;
            app = a;
        }
